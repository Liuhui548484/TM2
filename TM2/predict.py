...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='TCDformer.csv', help='data file')
    ...
    parser.add_argument('--detail_freq', type=str, default='s', help='like freq, but use in predict')
